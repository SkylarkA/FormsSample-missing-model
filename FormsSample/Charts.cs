...
namespace FormsSample
{
	public class Charts : Application
	{
		...
		async void CreateScene ()
		{
            ...
            jackNode = scene.CreateChild();
            jackNode.Position = new Vector3(3, 3, 4);
            jackNode.Scale = new Vector3(2, 2, 2);
            StaticModel jack = jackNode.CreateComponent<StaticModel>();
            jack.Model = this.ResourceCache.GetModel("Data/Jack.mdl");
